    ...
    <van-form @submit="onSubmit" class="addBo">
      ...
      >
        <div class="van-picker__toolbar">
          ...
          <button type="button" class="van-picker__confirm" @click="">
            新建客户
          </button>
        </div>
      </van-popup>
      ...
      <van-popup v-model="boSelectResponsibleShow" position="bottom">
        <div class="van-picker__toolbar">
          ...
          <button type="button" class="van-picker__confirm" @click=""></button>
        </div>
      </van-popup>
  ...
  watch: {
    $route: {
      ...
      handler: function (to, from) {
        ...
        this.getUserInfo(to.query.id, to.query.customerName);
      },
    },
  },
